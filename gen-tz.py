...
if __name__ == "__main__":
    ...
    group.add_argument("-mj", "--minimal-json", action="store_true", help="outputs minimal de-duplicated JSON")
    group.add_argument("-mc", "--minimal-jcsv", action="store_true", help="outputs minimal de-duplicated CSV")
